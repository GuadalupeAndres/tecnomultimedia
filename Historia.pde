class Historia {
  ...
  Historia() {
    ...
    this.pantallas[4]=new Pantalla(1, "Volver", "", 4);
    this.pantallas[5]=new Pantalla(1, "Siguiente", "", 5);
    this.pantallas[6]=new Pantalla(1, "Siguiente", "", 6);
    this.pantallas[7]=new Pantalla(2, "Eliges enfrentarlos", "Eliges contarle a\n Livesey", 7);
    this.pantallas[8]=new Pantalla(1, "Siguiente", "", 8);
    this.pantallas[9]=new Pantalla(2, "Prefieres contarle\na Trelawny", "Eliges no contarle\na Trelawny", 9);
    this.pantallas[10]=new Pantalla(2, "Eliges frenarte", "Eliges correr", 10);
    this.pantallas[11]=new Pantalla(1, "Siguiente", "", 11);
    this.pantallas[12]=new Pantalla(1, "Volver", "", 12);
    this.pantallas[13]=new Pantalla(1, "Siguiente", "", 13);
    this.pantallas[14]=new Pantalla(2, "Te unes a ellos", "Rechazas la oferta", 14);
    this.pantallas[15]=new Pantalla(1, "Volver", "", 15);
    this.pantallas[16]=new Pantalla(1, "Volver", "", 16);
    this.pantallas[17]=new Pantalla(2, "Confias en el", "No confias", 17);
    this.pantallas[18]=new Pantalla(1, "Siguiente", "", 18);
    this.pantallas[19]=new Pantalla(2, "Vas al barco", "No vas al barco", 19);
    this.pantallas[20]=new Pantalla(1, "Volver", "", 20);
    this.pantallas[21]=new Pantalla(1, "Siguiente", "", 21);
    this.pantallas[22]=new Pantalla(1, "Siguiente", "", 22);
    this.pantallas[23]=new Pantalla(2, "No lo detienes", "Huyes con el", 23);
    this.pantallas[24]=new Pantalla(1, "Volver", "", 24);
    this.pantallas[25]=new Pantalla(1, "Volver", "", 25);
  }
  ...
  void dibujar() {
    if (pantalla==1) {
      ...
      this.juego.dibujar();
      if (this.juego.gane()==true) {
        this.pantalla=21;
      } else if (this.juego.perdi()==true) {
        this.pantalla=20;
      }
    } else if (pantalla==26) {
    } else {
