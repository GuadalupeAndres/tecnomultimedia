class JMapa {
  ...
  void dibujar() {
      ...
      for (int f=0; f<15; f++) {     
        this.celdas[posArbolX[f]][posArbolY[f]].crearArbol(new JArbol());
      }
    
    this.celdas[this.posx][this.posy].crearPersonaje(new JPersonaje());

    this.celdas[this.posxEnemigo][this.posyEnemigo].crearEnemigo(new JEnemigo());
    this.moverAlEnemigo();
